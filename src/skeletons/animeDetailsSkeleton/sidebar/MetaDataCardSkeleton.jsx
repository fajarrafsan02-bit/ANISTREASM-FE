            ...
            <div className="flex flex-col gap-1.5">
                {[...Array(5)].map((_, index) => (
                    <div key={index} className="flex items-center w-full py-0.5">
                        {/* Icon box */}
                        <div className={`shrink-0 w-5 h-5 rounded border animate-pulse ${
                            isDark 
                        ...
                        {/* Label */}
                        <div className={`shrink-0 ml-2.5 h-2.5 w-20 rounded animate-pulse ${
                            isDark ? "bg-[#2a1117]" : "bg-slate-200"
                        }`} />

                        {/* Dotted line */}
                        <div className={`grow border-b border-dotted mx-3 mt-[3px] opacity-60 ${
                            isDark ? "border-[#1b0a0e]" : "border-slate-300"
                        }`} />

                        {/* Value */}
                        <div className={`shrink-0 h-4 w-24 rounded animate-pulse ${
                            isDark ? "bg-[#2a1117]" : "bg-slate-200"
                        }`} />
                    </div>
                ))}
