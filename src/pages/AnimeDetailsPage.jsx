...
export default function AnimeDetailsPage() {
    ...
    const commentsApi = useComments(anime?.animeId);
        ...
        >
            ...
            <div className="fixed top-[72px] left-4 sm:absolute sm:top-8 sm:left-7 md:top-10 md:left-10 lg:left-12 z-9999 flex items-center gap-2">
                ...
                <button
                    onClick={() => navigate(-1)}
                    aria-label="Kembali"
                    className={`group flex items-center justify-center gap-2 sm:gap-2.5 h-10 sm:h-9 px-3 sm:pl-3 sm:pr-4 rounded-full sm:rounded-xl backdrop-blur-md border active:scale-95 transition-all duration-300 shadow-sm ${isDark
                ...
                <Link
                    to="/"
                    aria-label="Beranda"
                    className={`group flex items-center justify-center h-10 sm:h-9 w-10 sm:w-9 rounded-full sm:rounded-xl backdrop-blur-md border active:scale-95 transition-all duration-300 shadow-sm ${isDark
                            ? "bg-[#070204]/85 border-[#ff1e56]/20 text-[#ff1e56] hover:text-white hover:bg-[#ff1e56] hover:border-[#ff1e56] hover:shadow-[0_0_20px_rgba(255,30,86,0.35)]"
                            : "bg-white/90 border-rose-200 text-rose-500 hover:text-white hover:bg-[#ff1e56] hover:border-[#ff1e56] hover:shadow-[0_0_20px_rgba(255,30,86,0.25)]"
                        }`}
                >
                    <i className="fa-solid fa-house text-[12px] group-hover:-translate-y-0.5 transition-transform duration-300" />
                </Link>
            </div>
