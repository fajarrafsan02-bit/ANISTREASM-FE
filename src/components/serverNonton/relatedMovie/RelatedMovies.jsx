...
{canScrollLeft && (
    <>
        <div
            className={`absolute left-0 top-0 bottom-0 w-6 sm:w-10 lg:w-20 z-20 pointer-events-none transition-opacity duration-500 bg-gradient-to-r ${isDark
                ? "from-[#050203] via-[#050203]/70 via-[#050203]/20 to-transparent"
                : "from-[#faf8f5] via-[#faf8f5]/70 via-[#faf8f5]/20 to-transparent"
            }`}
        />
        ...
        >
            <div className={`w-5 h-5 max-[320px]:w-4 max-[320px]:h-4 sm:w-7 sm:h-7 rounded-full backdrop-blur-sm flex items-center justify-center transition-all duration-300 group-hover/paddle:scale-110 ${isDark
                ? "bg-white/10 hover:bg-white/20 border border-white/10 hover:border-white/20 shadow-[0_0_15px_rgba(255,255,255,0.05)]"
                : "bg-slate-100/90 hover:bg-white border border-slate-200 hover:border-slate-300 shadow-[0_2px_10px_rgba(148,163,184,0.1)]"
            }`}>
...
{canScrollRight && (
    <>
        <div
            className={`absolute right-0 top-0 bottom-0 w-6 sm:w-10 lg:w-20 z-20 pointer-events-none transition-opacity duration-500 bg-gradient-to-l ${isDark
                ? "from-[#050203] via-[#050203]/70 via-[#050203]/20 to-transparent"
                : "from-[#faf8f5] via-[#faf8f5]/70 via-[#faf8f5]/20 to-transparent"
            }`}
        />
