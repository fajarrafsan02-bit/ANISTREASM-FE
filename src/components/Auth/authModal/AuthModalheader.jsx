...
export default function AuthModalHeader() {
    ...
    return (
        <div className="relative flex flex-col items-center pt-2 mb-6 select-none overflow-hidden">
            {/* Ambient Glow Backdrop (Efek Cahaya Sinematik) */}
            ...
            <div className="flex flex-col items-center gap-3 relative z-10">
                {/* Layered Premium Logo Badge */}
                <div className={`w-11 h-11 rounded-2xl flex items-center justify-center border transition-all duration-300 ${isDark
                ...
                <div className="text-center space-y-1">
                    <h1 className={`text-2xl font-black tracking-[-0.03em] ${isDark
                    ...
                    {/* Sub-label Gaya Minimalis Mewah */}
                    <p className={`text-[9px] font-semibold tracking-[0.25em] uppercase text-center transition-colors duration-300 ${isDark ? "text-zinc-500" : "text-zinc-400"
                        }`}>
                        Premium Hub
                    </p>
                </div>
