    ...
    return (
        <>
            ...
            >
                {/* Top glow line */}
                <div
                    className={`absolute top-0 left-0 right-0 h-px ${isDark ? "bg-gradient-to-r from-transparent via-[#ff1e56]/30 to-transparent" : "bg-gradient-to-r from-transparent via-rose-300/50 to-transparent"}`}
                />
                                                ...
                                                >
                                                    ...
                                                    <div className="flex-1 min-w-0 overflow-hidden">
                                                        ...
                                                        <div className="flex items-center gap-2 mt-1">
                                                            <span
                                                                className={`inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md text-[9px] font-black uppercase tracking-wider border bg-gradient-to-r ${typeStyle}`}
                                                            >
                    ...
                    <div className="flex flex-col min-h-0 flex-1 relative">
                        ...
                        <ul className="overflow-y-auto flex-1 overscroll-contain py-1">
                            {results.map((anime, i) => {
                                ...
                                const typeStyle =
                                    TYPE_GRADIENT[anime.type] ?? TYPE_GRADIENT.Special;
                                return (
